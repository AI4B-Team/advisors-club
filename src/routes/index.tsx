        ...
        <div className="replace-inner">
          ...
          <div className="replace-grid">
            ...
            <div className="replace-winner" style={{ position: "relative" }}>
              ...
              <div className="rw-logo" style={{ background:"transparent", padding:0, width:"auto", height:72, borderRadius:0, marginBottom:18, justifyContent:"flex-start" }}><img src={advisorsLogoDark} alt="AdvisorsClub" style={{ height:"100%", width:"auto", objectFit:"contain", display:"block" }} /></div>
