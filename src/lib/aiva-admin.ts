...
export const FACT_SECTIONS: { key: KnowledgeFactKey; label: string; hint: string }[] = [
  ...
  { key: "your-offers", label: "Your Offers", hint: "Coaching programs, prices, and what each one delivers." },
...
export const CAPABILITIES: {
  ...
  { id: "recommend-programs", label: "Recommend Coaching", blurb: "Points members to the right offer for their goal.", group: "Member Experience" },
