import realestate from "@/assets/covers-soft/realestate.jpg";
import startup from "@/assets/covers-soft/startup.jpg";
import fitness from "@/assets/covers-soft/fitness.jpg";
import ai from "@/assets/covers-soft/ai.jpg";
import investing from "@/assets/covers-soft/investing.jpg";
import marketing from "@/assets/covers-soft/marketing.jpg";
import mindset from "@/assets/covers-soft/mindset.jpg";
import crypto from "@/assets/covers-soft/crypto.jpg";
import sales from "@/assets/covers-soft/sales.jpg";
import wealth from "@/assets/covers-soft/wealth.jpg";
...
export const CLUBS: Club[] = [
  ...
  { id: "6", name: "Inbound Engine", tagline: "SEO, content & paid funnels that actually convert.", category: "Marketing", advisor: "Priya Shah", rating: 4.8, members: 1670, price: 89, cover: marketing, trending: true, isNew: true, tags: ["marketing","seo","content"] },
  ...
  { id: "9", name: "Closer's Edge", tagline: "Outbound, discovery & closing for B2B reps.", category: "Sales", advisor: "Jordan Cole", rating: 4.8, members: 1280, price: 69, cover: sales, isNew: true, tags: ["sales","b2b","outbound"] },
