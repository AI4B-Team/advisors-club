    ...
    groups: [
      {
        ...
        rows: [
          ...
          { id: "navigation", label: "Club Navigation", desc: "Rename, Reorder And Organize Your Menu.", to: "/app/manage/navigation" },
    ...
    groups: [
      {
        ...
        rows: [
          ...
          { id: "persona", label: "AI Persona", desc: "The Member-Facing AI Trained On You.", to: "/app/manage/persona" },
        ],
      },
    ],
  },
    ...
    groups: [
      {
        ...
        rows: [
          ...
          { id: "paywalls", label: "Paywalls", desc: "What Is Gated And Who Can Unlock It.", panel: "paywalls" },
